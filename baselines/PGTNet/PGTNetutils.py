...
def eventlog_class_provider(name_of_dataset):
    ...
    elif name_of_dataset == "BPIC20_DomesticDeclarations" or name_of_dataset == "BPIC20DD":
        pyg_class_name = "EVENTBPIC20D"
    elif name_of_dataset == "BPIC20_InternationalDeclarations" or name_of_dataset == "BPIC20ID":
        pyg_class_name = "EVENTBPIC20I"
    elif name_of_dataset == "BPIC20PTC":
        pyg_class_name = "EVENTBPIC20P"
...
def mean_cycle_norm_factor_provider(dataset):
    ...
    elif dataset == "BPIC20PTC" or dataset == "2020P" or ("EVENTBPIC20P" in dataset):
        mean_cycle = 11.50
        normalization_factor = 324.976
    elif dataset == "BPIC17" or dataset == "2017" or ("EVENTBPIC17" in dataset):
        mean_cycle = 19.1
        normalization_factor = 169.031
...
def eventlog_name_provider(name_of_class):
    ...
    elif name_of_class == "EVENTBPIC20P":
        event_log_name = "BPIC20PTC"
